# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 23:08:05 2020

Euler problem 8, Largest product in a series
09/07/2020, solved by 351342

@author: heatherq
"""

original = '''73167176531330624919225119674426574742355349194934
...
# get the answer for Euler problem 8
s = original
n = 13
number, product = compute(s, n)
print('The original 1000-digit number is {}'.format(s))
print('The {} adjacent digits in this number that have the greatest product are {}'.format(n, number))
print('The value of this greatest product is {}'.format(product))
